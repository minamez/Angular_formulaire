...
const routes: Routes = [
  ...
  {path: '', redirectTo: 'signup', pathMatch:'full'},// quand on fait http://localhost:4200/ , on est redirigé vers le formulaire
  {path: 'signup', component: SignupformComponent},// quand on fait http://localhost:4200/signup , on est dirigé vers le formulaire
  {path: 'home', component: HomeComponent}// quand on fait http://localhost:4200/home , on est dirigé vers l'accueil'
];
